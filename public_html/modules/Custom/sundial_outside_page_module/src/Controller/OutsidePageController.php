...
/**
 * @file
 * Contains \Drupal\sundial_outside_page_module\Controller\OutsidePageController.
 */
 
namespace Drupal\sundial_outside_page_module\Controller;
...
class OutsidePageController extends ControllerBase {
  public function outsideList() {
    $output = 'Hi Outdoors Module... <br>';
