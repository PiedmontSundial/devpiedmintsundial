...
/**
 * @file
 * Contains \Drupal\sundial_music_page_module\Controller\MusicPageController.
 */
 
namespace Drupal\sundial_music_page_module\Controller;
...
class MusicPageController extends ControllerBase {
  public function musicList() {
    $output = 'Hi Music Module... <br>';
