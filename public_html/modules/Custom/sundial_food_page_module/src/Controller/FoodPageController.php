...
/**
 * @file
 * Contains \Drupal\sundial_food_page_module\Controller\FoodPageController.
 */
 
namespace Drupal\sundial_food_page_module\Controller;
...
class FoodPageController extends ControllerBase {
  public function foodList() {
    $output = 'Hi Food Module... <br>';
