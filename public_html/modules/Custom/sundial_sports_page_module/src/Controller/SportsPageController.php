...
/**
 * @file
 * Contains \Drupal\sundial_sports_page_module\Controller\SportsPageController.
 */
 
namespace Drupal\sundial_sports_page_module\Controller;
...
class SportsPageController extends ControllerBase {
  public function sportsList() {
    $output = 'Hi Sports Module... <br>';
