...
/**
 * @file
 * Contains \Drupal\sundial_art_page_module\Controller\ArtPageController.
 */
 
namespace Drupal\sundial_art_page_module\Controller;
...
class ArtPageController extends ControllerBase {
  public function artList() {
    $output = 'Hi Art Module... <br>';
