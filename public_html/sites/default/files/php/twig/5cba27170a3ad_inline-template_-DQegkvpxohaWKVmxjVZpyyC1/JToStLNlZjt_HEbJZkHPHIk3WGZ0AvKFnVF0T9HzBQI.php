...
class __TwigTemplate_817f97810f52dbcbff97af84d3fe05f9e8e27029cd1ecf5def622156a754305f extends \Twig\Template
{
    ...
    {
        return new Source("{# inline_template_start #}{{ items | safe_join(separator) }}", "{# inline_template_start #}{{ items | safe_join(separator) }}", "");
    }
}
